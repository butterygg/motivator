...
import { DialogUserData } from '@/components/assessor/DialogUserData'
...
export type TestnetLeaderboardDatatable = {
...
export const columns: ColumnDef<TestnetLeaderboardDatatable>[] = [
    {
        accessorKey: 'id',
        id: 'id',
        cell: ({ row }) => (
    ...
    },
    {
        ...
        header: 'addressName',
        cell: ({ row }) => {
            const reward = row.getValue(
                'reward'
            ) as TestnetLeaderboardDatatable['reward']
            return (
...

    {
        accessorKey: 'stat',
        cell: ({ row }) => {
            const stat = row.getValue(
                'stat'
            ) as TestnetLeaderboardDatatable['stat']
            const pnl = row.getValue(
                'pnl'
            ) as TestnetLeaderboardDatatable['pnl']
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            const id = row.getValue('id') as TestnetLeaderboardDatatable['id']
...
export type Props = {
    users: TestnetLeaderboardDatatable[]
}

export function DataTableLeaderboardTestnet({ users }: Props) {
